public class Vuelo {
    ...
    public Vuelo(String codigoVuelo, String destino, String horaSalida){
        ...
        this.asientoReservado = null; // Por el momento vacío
    }

    // Método con parámetro y valor de retorno
    public boolean reservarAsiento(Pasajero p) {
        if(asientoReservado == null){ // Si aún no se reserva asiento
            asientoReservado =p; // Reservado
            return true;
        } else{
            return false; // No reservado
        }
    }

    // Este invoca al método anterior
